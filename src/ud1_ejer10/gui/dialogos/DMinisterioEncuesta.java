 ...
 */
public class DMinisterioEncuesta extends javax.swing.JDialog {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (practicaDeportes&&deportes.size()==0){
            mostrarError("Si marca que practica algún deporte debe eligir al menos un deporte");
            return;
        }
        //validacion sexo
        if (sexo.equals("")){
    ...
    /**
     * Genera un joptionpane de informacion de error
